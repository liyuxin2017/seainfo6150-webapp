...
const MarkedUpArticle = () => {
  return (
    <div id = 'articleBody'>
      <div id = 'firstParagraph' className = 'paragraphs'>
        The Statue of Liberty's original torch is getting a new home.
      </div>
      <div id = 'secondParagraph' className = 'paragraphs'>
      ...
      <div id = 'thirdParagraph' className = 'paragraphs'>
      ...
      <div id = 'fourthParagraph' className = 'paragraphs'>
      ...
      <div id = 'fifthParagraph' className = 'paragraphs'>
      ...
      <div id = 'sixthParagraph' className = 'paragraphs'>
      ...
      <div id = 'seventhParagraph' className = 'paragraphs'>
      ...
      <div id = 'eighthParagraph' className = 'paragraphs'>
      ...
      <div id = 'ninthParagraph' className = 'paragraphs'>
      ...
      <div id = 'thirteenthtParagraph' className = 'paragraphs'>
...
export default MarkedUpArticle;
