...
const MarkedUpArticle = () => {
  return (
    <div id = 'articleBody'>
      <p id = 'firstParagraph' className = 'paragraphs'>
        The Statue of Liberty's original torch is getting a new home.
      </p>
      <p id = 'secondParagraph' className = 'paragraphs'>
      ...
      <p id = 'thirdParagraph' className = 'paragraphs'>
      ...
      <p id = 'fourthParagraph' className = 'paragraphs'>
      ...
      <p id = 'fifthParagraph' className = 'paragraphs'>
      ...
      <p id = 'sixthParagraph' className = 'paragraphs'>
      ...
      <p id = 'seventhParagraph' className = 'paragraphs'>
      ...
      <p id = 'eighthParagraph' className = 'paragraphs'>
      ...
      <p id = 'ninthParagraph' className = 'paragraphs'>
      ...
      <p id = 'thirteenthtParagraph' className = 'paragraphs'>
